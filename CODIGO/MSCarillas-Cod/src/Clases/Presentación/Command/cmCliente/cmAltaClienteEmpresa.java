 ...
 */
public class cmAltaClienteEmpresa implements Command {
	/**
	 * <!-- begin-UML-doc --> <!-- end-UML-doc -->
	 * 
	 * @generated "UML a Java
	...
	public Contexto execute(Object data) {
		...
		if(ret > 0) {
			return new Contexto(Events.ALTA_CLIENTEE_OK,ret);
		}
		else return new Contexto(Events.ALTA_CLIENTEE_KO,ret);
	}
}