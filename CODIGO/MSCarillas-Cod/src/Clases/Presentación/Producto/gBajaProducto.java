...
public class gBajaProducto extends JFrame {
	private static final long serialVersionUID = 1L;
	private JPanel contentPanel;

	public gBajaProducto() {
	...
	public void init() {
		...
		JLabel lblNewLabel = new JLabel("Baja Producto");
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controller.getInstance().action(new Contexto(Events.BAJA_PRODUCTO, id));
					dispose();
				} catch (Exception es) {
