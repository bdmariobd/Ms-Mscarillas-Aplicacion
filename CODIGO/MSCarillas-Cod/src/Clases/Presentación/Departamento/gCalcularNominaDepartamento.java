...
public class gCalcularNominaDepartamento extends JFrame {
	/**
	 * 
	 */
	...
	public void init() {
		...
		JLabel lblNewLabel = new JLabel("Calcular la nomina de un departamento");
		...
		JLabel lblNewLabel_1 = new JLabel("Identificador del departamento");
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Controller.getInstance().action(
						new Contexto(
							Events.MOSTRAR_SUELDO_DEPARTAMENTO, id));
				}
				catch(Exception es) {
