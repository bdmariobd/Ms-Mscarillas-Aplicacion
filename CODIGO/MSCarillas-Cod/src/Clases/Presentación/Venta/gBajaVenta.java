...
public class gBajaVenta extends JFrame {
	...
	public void init() {
		...
		JLabel lblNewLabel = new JLabel("Dar de baja una venta");
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controller.getInstance().action(new Contexto(Events.BAJA_VENTA,id));
				}
				catch(Exception ex) {
