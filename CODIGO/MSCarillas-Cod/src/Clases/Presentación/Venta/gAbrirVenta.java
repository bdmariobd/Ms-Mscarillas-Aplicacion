...
public class gAbrirVenta extends JFrame {
	...
	public void init() {
		...
		JLabel lblNewLabel = new JLabel("Abrir venta");
		...
		JLabel lblNewLabel_1 = new JLabel("Identificador del cliente");
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controller.getInstance().action(new Contexto(Events.ABRIR_VENTA,id));
					dispose();
				}
				catch(Exception ex) {
