...
public class gMostrarEmpresa  extends JFrame{
	
	private static final long serialVersionUID = 1L;
	private JPanel contentPanel;
	
	public gMostrarEmpresa() {
			
	}
	
	public void update(Contexto contexto) {
		TEmpresa emp = (TEmpresa)contexto.getData();
		...
		JLabel lblNewLabel = new JLabel("Mostrar Empresa");
		...
		formattedTextField_ID.setValue(emp.getId());
		...
		formattedTextField.setValue(emp.getNombre());
		...
		formattedTextField_1.setValue(emp.getCif());
		formattedTextField_1.setEditable(false);
		...
		formattedTextField_2.setValue(emp.getSector());
		...
		formattedTextField_3.setValue(emp.getDireccion());
		...
		formattedTextField_Talla.setValue(emp.getCorreo());
		...
		formattedTextField_4.setValue(emp.getTelefono().toString());
		...
		formattedTextField_AC.setValue(emp.isActivo()? "ACTIVO":"NO ACTIVO");
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controller.getInstance().action(new Contexto(Events.MOSTRAR_EMPRESA,id));
				}
				catch(Exception ex) {
